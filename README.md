...
- Real-time data pipelines with Kafka & Spark
- Multi-agent AI systems with RAG and LLM orchestration
- Cloud data platforms on Azure (Fabric, Databricks)
